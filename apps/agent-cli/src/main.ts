...
program.command("listen")
  ...
  .option("-p, --prompt <template>", "Prompt template passed to the local agent. Supports {{transcript}}, {{trigger}}, {{recorded_at}}, {{event_id}}, {{ring_id}}, and {{source_message_id}}.", defaultPromptTemplate)
